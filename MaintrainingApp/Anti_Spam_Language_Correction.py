...
def startscreenrecorder():
        ...
        while AntiSpamEnabled:
            ...
            if platform == 'macosx':
                ...
                mactemplates = [cv2.imread('MaintrainingApp/macos_template_img2.png', 0), cv2.imread('MaintrainingApp/macos_template_img3.png', 0), cv2.imread('MaintrainingApp/macos_template_img4.png', 0), cv2.imread('MaintrainingApp/macos_template_img5.png', 0)] #reading the template image for mac from the assets file using opencv, and resize the image to fit the actual dimensions on the screen(2880 x 1880)
