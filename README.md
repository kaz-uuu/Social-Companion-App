...
This project has a requirements.txt file included to avoid installing all of these packages manually. Change directory to '''downloads/social-companion-app-main''' in your terminal and run <pre>-r requirements.txt<pre>.
